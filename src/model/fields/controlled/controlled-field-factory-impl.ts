...
class ControlledFieldFactoryImpl implements ControlledFieldFactory {
  ...
  createStateControlledFieldWithSyncControlFn(baseField: Field, stateControlFn: SyncFieldStateControlFn, fields: FormElementMap): StateControlledField {
    const adapter = this.#adapterFactory.createSyncAdapterFromFnWithFields(stateControlFn, fields);
    return new StateControlledField(baseField, adapter as SyncAdapter<FieldState | DualFieldSetStateArg>);
  }
  createStateControlledFieldWithAsyncControlFn(baseField: Field, stateControlFn: AsyncFieldStateControlFn, fields: FormElementMap): StateControlledField {
    const adapter = this.#adapterFactory.createAsyncAdapterFromFnWithFields(stateControlFn, fields);
    return new StateControlledField(baseField, adapter as AsyncAdapter<FieldState | DualFieldSetStateArg>);
  }
  createValueControlledFieldWithSyncControlFn(baseField: Field, valueControlFn: SyncFieldValueControlFn, fields: FormElementMap): ValueControlledField {
    const adapter = this.#adapterFactory.createSyncAdapterFromFnWithFields(valueControlFn, fields);
    return new ValueControlledField(baseField, adapter as SyncAdapter<string | DualFieldSetValueArg | undefined>);
  }
  createValueControlledFieldWithAsyncControlFn(baseField: Field, valueControlFn: AsyncFieldValueControlFn, fields: FormElementMap): ValueControlledField {
    const adapter = this.#adapterFactory.createAsyncAdapterFromFnWithFields(valueControlFn, fields);
    return new ValueControlledField(baseField, adapter as AsyncAdapter<string | DualFieldSetValueArg | undefined>);
  }
  createStateControlledDualFieldWithSyncControlFn(baseField: DualField, stateControlFn: SyncDualFieldStateControlFn, fields: FormElementMap): StateControlledDualField {
    const adapter = this.#adapterFactory.createSyncAdapterFromFnWithFields(stateControlFn, fields);
    return new StateControlledDualField(baseField, adapter);
  }
  createStateControlledDualFieldWithAsyncControlFn(baseField: DualField, stateControlFn: AsyncDualFieldStateControlFn, fields: FormElementMap): StateControlledDualField {
    const adapter = this.#adapterFactory.createAsyncAdapterFromFnWithFields(stateControlFn, fields);
    return new StateControlledDualField(baseField, adapter);
  }
  createValueControlledDualFieldWithSyncControlFn(baseField: DualField, valueControlFn: SyncDualFieldValueControlFn, fields: FormElementMap): ValueControlledDualField {
    const adapter = this.#adapterFactory.createSyncAdapterFromFnWithFields(valueControlFn, fields);
    return new ValueControlledDualField(baseField, adapter as SyncAdapter<string | DualFieldSetValueArg | undefined>);
  }
  createValueControlledDualFieldWithAsyncControlFn(baseField: DualField, valueControlFn: AsyncDualFieldValueControlFn, fields: FormElementMap): ValueControlledDualField {
    const adapter = this.#adapterFactory.createAsyncAdapterFromFnWithFields(valueControlFn, fields);
    return new ValueControlledDualField(baseField, adapter as AsyncAdapter<string | DualFieldSetValueArg | undefined>);
  }
}
