...
export class FinalizerFnFactoryImpl implements FinalizerFnFactory {
  ...
  createSyncFinalizerFn(baseAdapterFn: SyncBaseFinalizerFunction): SyncAdapterFn<FinalizerState> {
  ...
  createAsyncFinalizerFn(baseAdapterFn: AsyncBaseFinalizerFn): AsyncAdapterFn<FinalizerState> {
    return ((aggregatedStateChanges : AggregatedStateChanges) => {
