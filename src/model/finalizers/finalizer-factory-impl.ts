...
import { FinalizerFactory, FinalizerFactoryKey, FinalizerFactoryKeyType } from "./finalizer-factory.interface";
...
class FinalizerFactoryImpl implements FinalizerFactory {
  ...
  createSyncFinalizer(finalizerFn: SyncFinalizerFn, fields: FormElementDictionary): SyncFinalizer {
    const aggregator = this.#aggregatorFactory.createMultiFieldAggregatorFromFields(fields);
...
const FinalizerFactoryService = autowire<FinalizerFactoryKeyType, FinalizerFactory, FinalizerFactoryImpl>(
