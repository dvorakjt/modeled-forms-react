import {
  ConfirmationManager,
  TryConfirmArgsObjectWithValidity,
} from './confirmation-manager.interface';
...
export class ConfirmationManagerImpl implements ConfirmationManager {
  ...
  confirmationStateChanges: Subject<ConfirmationState> =
    new BehaviorSubject<ConfirmationState>(this.confirmationState);
  ...
  tryConfirm({
    ...
    onError,
    errorMessage,
  }: TryConfirmArgsObjectWithValidity): void {
