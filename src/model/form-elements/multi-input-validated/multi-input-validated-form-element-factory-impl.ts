...
import { MultiInputValidatedFormElementFactory, MultiInputValidatedFormElementFactoryKey, MultiInputValidatedFormElementFactoryKeyType } from "./multi-input-validated-form-element-factory.interface";
...
class MultiInputValidatedFormElementFactoryImpl implements MultiInputValidatedFormElementFactory {
  ...
  [
    ...
    if(baseField instanceof AbstractNestedForm) {
      ...
      const userFacingDualField = new UserFacingMultiInputValidatedDualField(baseField, userFacingReducer);
      return [userFacingDualField, finalizerFacingFormElement];
    } else {
      const userFacingField = new UserFacingMultiInputValidatedField(baseField, userFacingReducer);
      return [userFacingField, finalizerFacingFormElement];
    }
  }
}

const MultiInputValidatedFormElementFactoryService = autowire<MultiInputValidatedFormElementFactoryKeyType, MultiInputValidatedFormElementFactory, MultiInputValidatedFormElementFactoryImpl>(
...
export { MultiInputValidatedFormElementFactoryImpl, MultiInputValidatedFormElementFactoryService };