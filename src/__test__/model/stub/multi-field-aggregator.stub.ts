...
export class MultiFieldAggregatorStub<Fields extends FormElementMap>
  implements MultiFieldAggregator<Fields>
{
  ...
  constructor(subscriptionManager: SubscriptionManager) {
    this.aggregateChanges = subscriptionManager.registerSubject(
      new ReplaySubject<AggregatedStateChanges<Fields>>(),
    );
  }
}
