...
describe('MultiInputValidatorMessagesAggregatorImpl', () => {
  ...
  test('It deletes a message when a validator returns a null message.', () => {
    const validatorFn: SyncValidator<AggregatedStateChanges> = ({
      fieldA,
      fieldB,
    }) => {
    ...
    multiInputValidatorMessagesAggregator =
      new MultiInputValidatorMessagesAggregatorImpl([multiInputValidator]);
