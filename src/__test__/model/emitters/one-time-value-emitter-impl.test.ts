...
import { OneTimeValueEmitterImpl } from '../../../model/constituents/emitters/one-time-value-emitter-impl';
import type { OneTimeValueEmitter } from '../../../model/types/constituents/emitters/one-time-value-emitter.interface';
