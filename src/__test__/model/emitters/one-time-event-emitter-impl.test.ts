...
import { OneTimeEventEmitterImpl } from '../../../model/constituents/emitters/one-time-event-emitter-impl';
import type { OneTimeEventEmitter } from '../../../model/types/constituents/emitters/one-time-event-emitter.interface';
