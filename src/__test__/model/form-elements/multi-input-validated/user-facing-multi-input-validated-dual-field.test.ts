...
import { DualFieldSetStateArg, DualFieldSetValueArg, MessageType, Validity, required } from '../../../../model';
...
describe('UserFacingMultiInputValidatedDualField', () => {
  test('state returns the base form element\'s value.', () => {
    ...
    const baseField = container.services.BaseFieldFactory.createDualField(expectedValue, '', false, [], []);
    ...
    const userFacingMultiInputValidatedDualField = multiInputValidatedFormElements[0];

    expect(userFacingMultiInputValidatedDualField.state.value).toBe(expectedValue);
  });

  test('state returns the base form element\'s messages.', () => {
    const invalidMessageText = 'Field is required';

    const baseField = container.services.BaseFieldFactory.createDualField('', '', false, [required(invalidMessageText)], []);
  ...
  test('state returns the base form element\'s omit.', () => {
    const baseField = container.services.BaseFieldFactory.createDualField('', '', true, [], []);
  ...
  test('state returns the base form element\'s visited.', () => {
    ...
    expect(userFacingMultiInputValidatedDualField.state.visited).toBe(Visited.YES);
  });
  ...
  test('state returns the base form element\'s modified.', () => {
    ...
    expect(userFacingMultiInputValidatedDualField.state.modified).toBe(Modified.YES);
  });

  test('state returns the minimum of the base field\'s validity and any attached validator\'s validitiy.', () => {
    const fields = {
      fieldA : container.services.BaseFieldFactory.createDualField('', '', false, [required('Field A is required')], []),
    ...
    expect(userFacingMultiInputValidatedDualField.state.validity).toBe(Validity.INVALID);

    fields.fieldA.setValue({
      primaryFieldValue : 'new value'
    });

    expect(userFacingMultiInputValidatedDualField.state.validity).toBe(Validity.VALID_FINALIZABLE);
  ...
  test('state returns the baseField\'s useSecondaryField property.', () => {
    ...
    expect(userFacingMultiInputValidatedDualField.state.useSecondaryField).toBe(false);

    baseField.setState({
      useSecondaryField : true
    });

    expect(userFacingMultiInputValidatedDualField.state.useSecondaryField).toBe(true);
  });
  ...
  test('primaryField returns the base field\'s primary field.', () => {
    ...
    const userFacingMultiInputValidatedDualField = multiInputValidatedFormElements[0] as UserFacingMultiInputValidatedDualField;

    expect(userFacingMultiInputValidatedDualField.primaryField).toBe(primaryField);
  });
  ...
  test('secondaryField returns the base field\'s secondary field.', () => {
    ...
    expect(userFacingMultiInputValidatedDualField.secondaryField).toBe(secondaryField);
  });
  ...
  test('useSecondaryField returns the base field\'s useSecondaryField.', () => {
    ...
    expect(userFacingMultiInputValidatedDualField.useSecondaryField).toBe(false);
  ...
  test('calling setState() calls the base field\'s setState() method.', () => {
    ...
    const userFacingMultiInputValidatedDualField = multiInputValidatedFormElements[0] as UserFacingMultiInputValidatedField;
