...
describe('SyncSingleInputValidatorSuite', () => {
  ...
  test('it does not run async validators if the sync result is INVALID.', () => {
    const syncValidatorSuite = new SyncSingleInputValidatorSuite<string>([
      failingSyncValidator,
    ]);
    const asyncValidatorSuite = new AsyncSingleInputValidatorSuite<string>(
      [passingAsyncValidator],
      '',
      subscriptionManager,
    );
    const hybridValidatorSuite = new HybridSingleInputValidatorSuite<string>(
      syncValidatorSuite,
      asyncValidatorSuite,
    );
  ...
  test('it does not run async validators if the sync result is ERROR', () => {
    const syncValidatorSuite = new SyncSingleInputValidatorSuite<string>([
      throwErrorSync as SyncValidator<string>,
    ]);
    const asyncValidatorSuite = new AsyncSingleInputValidatorSuite<string>(
      [passingAsyncValidator],
      '',
